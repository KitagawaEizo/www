...
<div align="center"><img src="./imgs/20.png" width="60%"></div>
...
<div align="center"><img src="./imgs/21.png" width="60%"></div>
...
<div align="center"><img src="./imgs/22.png" width="60%"></div>
...
<div align="center"><img src="./imgs/23.png" width="60%"></div>
...
<div align="center"><img src="./imgs/24.png" width="60%"></div>
...
<div align="center"><img src="./imgs/25.png" width="60%"></div>
...
<div align="center"><img src="./imgs/27.png" width="60%"></div>
...
<div align="center"><img src="./imgs/28.png" width="60%"></div>
...
<div align="center"><img src="./imgs/29.png" width="60%"></div>
...
例えば，「ゲームをプレイしつつ配信したい」などの場合，dGPU（NVIDIA GeForce / AMD Radeon など）の方でゲームの描画処理をさせつつ，スクリーンキャプチャで取り込んだ映像を iGPU（Intel QSV）でエンコードさせるように処理を割り振ると，お互いの処理に影響し合うことを防げるため，ゲームプレイと配信を安定して並行できます．

4. 「設定」>「詳細設定」>「録画」より，「ファイル名書式設定」を「`%CCYY-%MM-%DD_%hh-%mm-%ss_OBSREC`」にする

これにより，録画ファイル名に録画開始日時が付与され，管理しやすくなります．また，OBS で録画したファイルであることも分かるようになります．  
なお，日付時刻のフォーマットは ISO 8601 に準拠しています．
